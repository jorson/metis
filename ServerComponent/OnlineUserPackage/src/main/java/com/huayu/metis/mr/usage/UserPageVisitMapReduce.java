 ...
 */
public class UserPageVisitMapReduce {
    ...
    public static class UserVisitPageReducer extends Reducer<UserPageVisitKey, IntWritable, UserPageVisitKey, UserPageVisitTimes> {
        ...
        protected void reduce(UserPageVisitKey key, Iterable<IntWritable> values, Context context)
            ...
            context.write(key, new UserPageVisitTimes(sum));
        }
    }
}
