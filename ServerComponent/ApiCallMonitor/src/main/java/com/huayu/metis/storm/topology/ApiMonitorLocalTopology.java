 ...
 */
public class ApiMonitorLocalTopology {

    public static void main(String[] args) throws Exception {

        String configPath = Thread.currentThread().getContextClassLoader()
                .getResource("apimonitor.properties").getPath();
        System.out.println(configPath);
        //获取组件的配置
        ApiMonitorConfig apiMonitorConfig = new ApiMonitorConfig(configPath);
        ...
        cluster.submitTopology("api_monitor", config, builder.createTopology());
